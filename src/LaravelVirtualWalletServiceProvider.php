...
namespace Haxneeraj\LaravelVirtualWalletPro;
...
class LaravelVirtualWalletServiceProvider extends ServiceProvider
{
    ...
    private function addConfigFiles(): void
    {
        ...
        $this->publishes([
            __DIR__ . '/../config/laravel-virtual-wallet.php.stub' => config_path('laravel-virtual-wallet.php'),
        ], 'config');
    }
    ...
    {
        // Load migrations so they can be used by the package
